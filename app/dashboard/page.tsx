            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 text-white">
              ...
              <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[1, 2, 3, 4].map((item) => (
                    <Link href="/editor" key={item}>
                      <div className="bg-white/5 border border-white/10 rounded-lg p-4 hover:bg-white/10 transition cursor-pointer">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    ...
                    <Link href="/editor" key={i}>
                      <div className="bg-white/5 border border-white/10 rounded-lg p-4 hover:bg-white/10 transition cursor-pointer flex items-center">
