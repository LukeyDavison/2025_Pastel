...
export function EmailCanvasImproved() {
              ...
              <AnimatePresence>
                {currentTemplate.blocks.map((block) => (
                  ...
                  >
                    ...
                    <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex space-x-1 bg-white/80 backdrop-blur-sm rounded p-1 shadow-sm">
